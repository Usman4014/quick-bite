...
import 'package:quick_bite/views/product/write_review_dialog.dart';
...
class ProductReviews extends StatefulWidget {
  ...
  @override
  State<ProductReviews> createState() =>
      _ProductReviewsState();
}

class _ProductReviewsState
    extends State<ProductReviews> {
  //============================================================
  // CONTROLLER
  //============================================================
  ...
  void initState() {
    ...
    reviewController.loadProductReviews(
      widget.product.id,
    );
  }
...
class _ReviewItem
  ...
  @override
  State<_ReviewItem> createState() =>
      _ReviewItemState();
}

class _ReviewItemState
    extends State<_ReviewItem> {
  UserModel? user;
...
class _ProfileImagePlaceholder
    extends StatelessWidget {
  const _ProfileImagePlaceholder();
