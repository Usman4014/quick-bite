...
class EmptyPaymentMethod extends StatefulWidget {
  const EmptyPaymentMethod({super.key});

  @override
  State<EmptyPaymentMethod> createState() => _EmptyPaymentMethodState();
}

class _EmptyPaymentMethodState extends State<EmptyPaymentMethod> {
  String? _loadingUrl;
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // TITLE
            //==================================================
            Text("No Payment Methods", style: AppTextTheme.appbarText),
