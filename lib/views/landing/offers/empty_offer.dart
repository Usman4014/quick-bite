...
class EmptyOffer extends StatefulWidget {
  const EmptyOffer({super.key});

  @override
  State<EmptyOffer> createState() => _EmptyOfferState();
}

class _EmptyOfferState extends State<EmptyOffer> {
  String? _loadingUrl;
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // TITLE
            //==================================================
            Text("No Active Offers", style: AppTextTheme.appbarText),
